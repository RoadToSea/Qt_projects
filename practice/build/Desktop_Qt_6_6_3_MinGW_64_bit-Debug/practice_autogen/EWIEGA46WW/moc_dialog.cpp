...
Q_CONSTINIT static const qt_meta_stringdata_CLASSDialogENDCLASS_t qt_meta_stringdata_CLASSDialogENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(7, 22),  // "on_registerBtn_clicked"
        QT_MOC_LITERAL(30, 0),  // ""
        QT_MOC_LITERAL(31, 19)   // "on_loginBtn_clicked"
    },
    "Dialog",
    "on_registerBtn_clicked",
    "",
...
void *Dialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "std::enable_shared_from_this<Dialog>"))
        return static_cast< std::enable_shared_from_this<Dialog>*>(this);
