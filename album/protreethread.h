...
signals:
    ...
    void finishImport(QTreeWidgetItem* lastItem);
public slots:
    void slot_cancelImport(void);

public:
    proTreeThread(QTreeWidget* self,QTreeWidgetItem* root,QTreeWidgetItem* lastItem,QString src_path,QString dst_path,int& file_count,QObject*parent = nullptr);
